...
- Mining the tile a torch is mounted on **drops the torch as a pickup** rather than leaving it floating — the support re-check, owned by [automation.md](automation.md) §Support & popping.
